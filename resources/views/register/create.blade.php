    ...
    <section class="mx-auto block p-6 rounded-lg shadow-lg bg-gray-100 max-w-sm">
        <form action="#" method="post">
            ...
            <div class="form-group mb-6">
                ...
                <input type="text"
                       class="form-control @error('username') border-red-500 @else border-gray-300 @enderror block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                       id="username"
                       name="username"
                       value="{{ old('username') }}"
            ...
            <div class="form-group mb-6">
                <label for="full_name" class="form-label inline-block mb-2 text-gray-700">Full Name</label>
                <input type="text"
                       class="form-control @error('name') border-red-500 @else border-gray-300 @enderror block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                       id="full_name"
                       name="name"
                       value="{{ old('name') }}"
                       aria-describedby="nameHelp" placeholder="Enter your name">
